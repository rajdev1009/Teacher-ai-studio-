...
export default function App() {
    ...
    (async () => {
      try {
        ...
        if (key && key !== 'undefined') {
          ...
          setConfigError('GEMINI_API_KEY missing! Render environment variables-এ set করো।');
        }
      } catch {
        setConfigError('Server-এর সাথে connect হচ্ছে না।');
      } finally {
  ...
  }, [chatService, voiceName, currentMood]);
  ...
  const handleReconnect = useCallback(() => {
    ...
    if (reconnectAttemptsRef.current < MAX_RECONNECT) {
      ...
      stopLive();
      setConfigError('Connection stable নেই। Page refresh করো আর আবার try করো।');
    }
  }, [startLive, stopLive]);
        ...
        <header className="flex items-center justify-between px-6 py-4">
          <div>
            <h1 className="text-white font-bold text-xl tracking-tight">
              রাজ <span className="text-pink-400">✦</span>
            </h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className={cn(
              ...
              isLive ? 'bg-green-400 animate-pulse' : chatService ? 'bg-green-400' : 'bg-red-400'
            )} />
          </div>
        </header>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            >
              {isInitializing ? (
                ...
                <span className="flex items-center gap-2">
                  ...
                  <span className="ml-1">বন্ধ করো</span>
                </span>
              ) : '🎙 রাজের সাথে কথা বলো'}
            </motion.button>
            ...
            <p className="text-white/30 text-xs text-center">
              {isLive
                ? isUserSpeaking
                  ? '⚡ রাজকে থামিয়ে দিলি!'
                  : 'রাজ শুনছে... আবার tap করলে বন্ধ হবে'
                : 'Tap করো আর রাজের সাথে বাংলায় কথা বলো'}
            </p>
          </div>
